...
![banner](https://yun.swimly.cn/source/ikoolcore/banner.png)
...
> **提示：**可行，但不推荐。R1产品定位没有为NAS场景考虑

### 家庭媒体服务器

借助诸如jellyfin, Plex, alist等docker工具，轻松扮演家庭内网的媒体服务器。

![Banner_tw](https://yun.swimly.cn/source/ikoolcore/Banner_tw.png)
