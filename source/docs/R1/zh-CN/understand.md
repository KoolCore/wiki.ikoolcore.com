...
> **方寸之间 尽享乐趣！**>**极致小巧 颜值在线**>**性能强大**>**多网口2.5G**>**拒绝傻大黑粗**>**拒绝减/简配！拒绝电子垃圾**聚集一群有共同兴趣爱好的小伙伴
...
- 网卡：Intel i226-V**（优于Intel i225-V）**- 硬盘：**M.2 NVME 2242 （x2速率）NVME/SATA双协议支持，但默认BIOS仅支持NVME协议硬盘。如有需要，后续放出支持SATA协议的BIOS。**- 显示：HDMI 2.0 4K 60Hz视频输出

- USB： USB 3.1 Gen1 x 2；USB-C 3.1 Gen1 x 2；

- TF：TF Card Slot x 1**（支持启动）已测试：Linux下可启动，Windows不可启动**- 散热：主动散热**后续会有升级版本散热器单独销售。散热是我们一直会努力优化的点。**- 电源：标配 12V 2.5A 30W DC电源**（定制Type C接口电源）

> **提示：**> 特殊定制DC电源，请使用标配电源给R1供电！请勿使用其他C口PD电源供电，以免烧坏主板。因乱用电源烧坏主板，需要自行承担！

- 尺寸：7.5 x 7.5 x 4.8cm**(方寸之间，尽享乐趣)**#### 工程设计

![测试](https://wiki.ikoolcore.cn/images/DesignFile_2.png)

![DesignFile_3](https://wiki.ikoolcore.cn/images/DesignFile_3.png)

![DesignFile_4](https://wiki.ikoolcore.cn/images/DesignFile_4.png)

![DesignFile_1](https://wiki.ikoolcore.cn/images/DesignFile_1.png)
...
购买之前，请知悉！**内存**：为双颗粒双通道的板载内存，一经购买不能升级，请按自身需求酌情购买。**硬盘**：`NVMe`协议，（SATA协议需求少，暂不生产）,[`淘宝链接`](https://item.taobao.com/item.htm?ft=t&id=686963354915)

| CPU   | 内存 | 硬盘      | 价格          | 购买链接                                                      |
| ----- | ---- | --------- | ------------- | ------------------------------------------------------------- |
| N5105 | 8GB  | 不带/128G | ￥999/￥1199  | [购买](https://item.taobao.com/item.htm?ft=t&id=682025492099) |
| N5105 | 16GB | 不带/512G | ￥1299/￥1699 | [购买](https://item.taobao.com/item.htm?ft=t&id=682025492099) |
| N6005 | 8GB  | 不带/128G | ￥1199/￥1399 | [购买](https://item.taobao.com/item.htm?ft=t&id=682025492099) |
| N6005 | 16GB | 不带/512G | ￥1399/￥1899 | [购买](https://item.taobao.com/item.htm?ft=t&id=682025492099) |
...
> **提示：**硬酷科技找OEM合作厂商专属定制**低温盘**，质保3年，放心使用。

-[**硬盘**](https://item.taobao.com/item.htm?ft=t&id=686963354915)芯片信息：

- NVMe主控：联芸(Maxio)科技**MAP1202A-F1C**>**提示：**使用此款芯片的市售产品有： [海康威视CC500](https://zhuanlan.zhihu.com/p/394138333)

> 、[Lexar雷克沙NM610PRO](https://diy.pconline.com.cn/1535/15359085.html) 、[致态TiPlus5000](https://www.chongdiantou.com/archives/137851.html)
...
- R1整机 x 1**CPU型号和板载内存大小因消费者选购不同而有差异**- VESA支架 x 1**支持7 x 7cm 和 10 x 10cm两种尺寸**- 12V 2.5A DC转C专用电源 x 1**专用电源，请勿用于其他设备，其他设备电源也请勿用于R1，烧坏需付费维修**- 说明书 x 1**纸质，中英双语。阅读在线[电子版](https://wiki.ikoolcore.cn/#/)说明书**- M.2 2242 NVMe 硬盘 x 1**仅限选购带硬盘配置订单，未选购硬盘配置不包含**### 发货说明
